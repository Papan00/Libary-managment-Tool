...
<body>
    <section>
        <div class="reg_img">
            ...
            <div class="box2">
                <h1 style="text-align: center; font-size: 35px;font-family: Lucida Console;"> &nbspLibrary
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($count == 0) {
            ...
            mysqli_query($db, "INSERT INTO `STUDENT` VALUES('$_POST[first]', '$_POST[last]', '$_POST[username]', '$_POST[password]', '$_POST[roll]', '$_POST[email]','10.jpg');");
    ?>
        ...
        ?>
            ...
            <div class="alert alert-danger" style="width: 360px;color:#fff;margin-left :450px;;background-color:#010100;">
                <strong>The username alredy exist.</strong>
            </div>
    <?php
        }
    }
